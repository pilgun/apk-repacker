...
def repackage(output_apk, input_apk, name):
    ...
    success = os.path.exists(output_apk)
...
def main():
    ...
    for app in list_of_apks:
        print("{0} - original - {1}".format(i, app.original))
...
class apk_info(object):
    def __init__(self, original='', piggy='', res_num1=0, res_num2=0, 
        f_score=0.0, certificates=''):
